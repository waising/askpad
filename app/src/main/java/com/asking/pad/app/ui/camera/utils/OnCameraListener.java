...
public class OnCameraListener {
    private static OnCameraListener a = null;
    private Context b;
    ...
    private abstract class b implements SensorEventListener {
        OnCameraListener dddd;

        private b(OnCameraListener hVar) {
            this.dddd = hVar;
        }
    ...
    private OnCameraListener(Context context) {
        if (context == null) {
    ...
    public static OnCameraListener a(Context context) {
        if (a != null) {
            return a;
        }
        a = new OnCameraListener(context);
        return a;
    }
