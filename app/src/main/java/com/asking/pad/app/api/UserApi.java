...
public interface UserApi {
    ...
    Observable<ResponseBody> communionapi(@Query("userName") String userName,@Query("mine") String mine,@Query("teacherId") String teacherId,@Query("grade") String grade, @Query("subject") String subject
