...
public class CommDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_comm_layout, null);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_ok://确认
                if (mListner != null) {
                    mListner.ok(position, id, CommDialog.this);
                }
                break;
    ...
    public interface DeleteListner {
        void ok(int position, String id, CommDialog deleteDialog);//确认删除
