...
/**
 * Created by wxwang on 2017/2/10.
 */
public class NumberAnimTextView extends TextView {
    ...
    //是否格式化数字为字符串
    private boolean mFormatNumStr = true;
    ...
    public void setFormatNumStr(boolean formatNumStr) {
        this.mFormatNumStr = formatNumStr;
    }
    ...
    private boolean checkNumString(String numberStart, String numberEnd) {
        try {
            new BigDecimal(numberStart);
            new BigDecimal(numberEnd);
            isInt = true;
        } catch (Exception e) {
            isInt = false;
            e.printStackTrace();
    ...
    private void start() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                setText(mPrefixString + (mFormatNumStr ? format(value) : formatValue(value)) + mPostfixString);
            }
        });
        animator.start();
    }
