...
import com.asking.pad.app.commom.SpaceItemDecoration;
...
public class ExamReviewExerAskFragment extends BaseFrameFragment<UserPresenter, UserModel> {
    ...
    public static ExamReviewExerAskFragment newInstance(int position,ExerAskEntity mTopicEntity, OnExerFragmentListener mListener) {
