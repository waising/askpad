...
public class ShopCartListActivity extends BaseFrameActivity<ShopCartPresenter, ShopCartModel> implements ShopCartAdapter.RecordDelListner, OnItemClickListener, DeleteDialog.DeleteListner {
    ...
    public static ShopCartListActivity newInstance() {
        ShopCartListActivity fragment = new ShopCartListActivity();
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_shop_cart_list);
    ...
    private void setHeader(RecyclerView view) {
        View header = LayoutInflater.from(this).inflate(R.layout.layout_shopcart_header, view, false);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case tv_check://支付
                ...
                intentConfirmOrder.setClass(ShopCartListActivity.this, ConfirmOrderActivity.class);
