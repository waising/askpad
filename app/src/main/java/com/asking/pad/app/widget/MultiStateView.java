...
public class MultiStateView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (errorViewResId > -1) {
            ...
            network_tv = (TextView) mErrorView.findViewById(R.id.network_tv);
            network_tv1 = (TextView) mErrorView.findViewById(R.id.network_tv1);
            network_tv2 = (TextView) mErrorView.findViewById(R.id.network_tv2);
            mErrorRefBtn = (Button) mErrorView.findViewById(R.id.error_refresh_btn);
        }
    ...
    public void setErrorVisibility(int vis){
        mErrorRefBtn.setVisibility(vis);
    }

    public void setEmptyVisibility(int vis){
        mEmptyRefBtn.setVisibility(vis);
    }

    public void setErrorOnClickLinstener(View.OnClickListener clickLinstener){
        mErrorRefBtn.setOnClickListener(clickLinstener);
    }
