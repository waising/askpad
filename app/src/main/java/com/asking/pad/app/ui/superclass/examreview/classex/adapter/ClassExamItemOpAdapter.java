...
public class ClassExamItemOpAdapter extends RecyclerView.Adapter<ClassExamItemOpAdapter.CommViewHolder> {
    private List<SubjectClass.SubjectOption> dataList;
    private LayoutInflater layoutInflater;

    public String rightAnswer;
    public String userAnswer;
    SubjectClass mSubjectClass;


    public ClassExamItemOpAdapter(Context context, SubjectClass mSubjectClass) {
        ...
        holder.rBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!mSubjectClass.isShowDetailsAnswer){
                    ...
                    mSubjectClass.userAnswer = e.getOptionName();
                    userAnswer = mSubjectClass.userAnswer;
                    notifyDataSetChanged();
                }
            }
        });

        if (mSubjectClass.isShowDetailsAnswer && !TextUtils.isEmpty(userAnswer)) {
