...
public class AskDoctorSecondFragment extends BaseFrameFragment<UserPresenter, UserModel> {
    String knowledgeId;
    ...
    public static AskDoctorSecondFragment newInstance(String knowledgeId) {
    ...
    public void initLoadData(String knowledgeId) {
        ...
        mPresenter.secondreviewzhuant(knowledgeId,"askbsyhs",new ApiRequestListener<String>(){
            @Override
