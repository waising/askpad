...
public class NormalListDialog extends BaseDialog<NormalListDialog> {
    ...
    /***/
    private int paddingTopBottom = 15;
    ...
    public View onCreateView() {
        ...
        mTvTitle.setPadding(dp2px(18), dp2px(paddingTopBottom), 0, dp2px(paddingTopBottom));
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            int top = dp2px(paddingTopBottom);
            int right = 0;
            int bottom = dp2px(paddingTopBottom);
