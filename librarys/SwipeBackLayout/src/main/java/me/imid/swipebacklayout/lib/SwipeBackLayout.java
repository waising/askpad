...
public class SwipeBackLayout extends FrameLayout {
    ...
    //控制滑动比
    private boolean isScrollPercent;
...
//                    scrollToFinishActivity();
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            //如果滑动比例不超过30%则回复
            if(mScrollPercent<DEFAULT_SCROLL_THRESHOLD && isScrollPercent&&mDragHelper.isRe){
                left = 0;
                top = 0;
            }
    ...
    public boolean isScrollPercent() {
        return isScrollPercent;
    }

    public void setScrollPercent(boolean scrollPercent) {
        isScrollPercent = scrollPercent;
    }
}
